...
- Платежи: регулярные (каждый месяц или по дням недели, цена × число дней в месяце) и разовые в текущем месяце; любой платёж можно исключить из месяца с причиной.
